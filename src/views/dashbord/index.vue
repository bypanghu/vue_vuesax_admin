    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full lg:w-1/2 mb-base">
        <vx-card slot="no-body" class="text-center bg-primary-gradient greet-user">
          ...
          <h1 class="mb-6 text-white">欢迎您，超级管理员</h1>
      ...
      <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full lg:w-1/5 mb-base">
                <statistics-card-line icon="ApertureIcon" statistic="智能CRM" statisticTitle="92.6K" :chartData="analyticsData.subscribersGained" type='area'></statistics-card-line>
            </div>
             <div class="vx-col w-full lg:w-1/5 mb-base">
                 <statistics-card-line icon="GitPullRequestIcon" statistic="语音路线" statisticTitle="12.6K" :chartData="analyticsData.newsletter" type='area'></statistics-card-line>
            </div>
             <div class="vx-col w-full lg:w-1/5 mb-base">
                <statistics-card-line icon="RefreshCcwIcon" statistic="号码清洗" statisticTitle="92.6K" :chartData="analyticsData.activeUsers" type='area'></statistics-card-line>
            </div>
             <div class="vx-col w-full lg:w-1/5 mb-base">
                <statistics-card-line icon="CheckCircleIcon" statistic="语音质检" statisticTitle="92.6K" :chartData="analyticsData.quarterlySales" type='area'></statistics-card-line>
            </div>
             <div class="vx-col w-full lg:w-1/5 mb-base">
                <statistics-card-line icon="CreditCardIcon" statistic="号卡申请" statisticTitle="92.6K" :chartData="analyticsData.subscribersGained" type='area'></statistics-card-line>
            </div>
