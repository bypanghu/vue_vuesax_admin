      ...
      <div @mouseenter="sidebarMouseEntered" @mouseleave="sidebarMouseLeave">
        ...
        >
          <template v-for="(sidebarItem, index) in sidebarItems">
            <template v-if="sidebarItem.children && sidebarItem.children.length == 1">
               <vx-sidebar-item
                ref="sidebarLink"
                :key="`sidebarItem-${index}`"
                :index="index"
                :to="sidebarItem.path +sidebarItem.children[0].path"
                :icon="sidebarItem.children[0].meta.icon"
              >
                <span v-show="!sidebarItemsMin" class="truncate">{{
                  sidebarItem.children[0].meta.name
                }}</span>
                <vs-chip
                  class="ml-auto"
